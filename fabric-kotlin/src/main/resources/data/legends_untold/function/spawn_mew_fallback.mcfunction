...
execute as @e[tag=MewFal] unless entity @e[type=cobblemon:pokemon,nbt={Pokemon:{Species:"cobblemon:mew"}}] run tellraw @s {"text":"Mew was just here, Maybe check again later"}
