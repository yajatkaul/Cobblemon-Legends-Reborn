...
execute as @e[tag=XrnFal] unless entity @e[type=cobblemon:pokemon,nbt={Pokemon:{Species:"cobblemon:xerneas"}}] run tellraw @s {"text":"Xerneas was just here, Maybe check again later"}
